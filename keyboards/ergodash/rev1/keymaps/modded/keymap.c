...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LBRC,                        KC_RBRC, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_PLUS, \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX,                        XXXXXXX, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   LOWER, \
    KC_LCTL, KC_LGUI, KC_LALT, KC_HOME,          LOWER,   KC_GRV ,KC_SPC,          KC_ENT, KC_GRV, RAISE,            KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
